...
Pašlaik mēs esam Publiskās beta versijas fāzē. Lai saņemtu informāciju par galvenajiem atjauninājumiem, skatiet šīs repozitorija "releases".
...
<table style="table-layout:fixed; white-space: nowrap;">
  ...
  <tr>
    ...
    <td>-</td>
    <td><a href="https://github.com/supabase-community/storage-go" target="_blank" rel="noopener noreferrer">uzglabāšana-go</a></td>
